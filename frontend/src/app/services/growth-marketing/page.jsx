        ...
        <div className="services-container">
          <div className="services-hero-grid">
            <div className="services-hero-left">
              ...
              <div className="services-category">Growth Marketing</div>
            </div>

            <div className="services-hero-right">
              <h1 className="services-hero-title">
                Accelerate Growth, Maximize Results
              </h1>
              <p className="services-hero-description">
                Growth is more than generating traffic—it's about attracting the right audience, converting them into customers, and building lasting relationships. At Kontent Kraft Digital, we combine data-driven marketing, creative storytelling, and performance optimization to help businesses increase brand awareness, generate qualified leads, and achieve sustainable growth across every digital channel.
              </p>
            </div>
          </div>
